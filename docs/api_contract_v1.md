...
Ілля відповідає за загальну архітектуру API, інтеграцію модулів, Videos, Categories, Video Reactions, Watch History, Favorites та Search.

Овсянко Тетяна відповідає за Auth, Users, Channels, Subscriptions, Comments, Comment Reactions та Playlists.
