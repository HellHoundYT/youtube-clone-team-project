...
export function createLibraryService(
  ...
  return {
    getWatchHistory:
      gateway.getWatchHistory,

    updateWatchHistory:
      gateway.updateWatchHistory,

    removeHistoryItem:
      gateway.removeHistoryItem,

    clearWatchHistory:
      gateway.clearWatchHistory,

    getHistoryStatus:
      gateway.getHistoryStatus,

    setHistoryPaused:
      gateway.setHistoryPaused,
